...
echo
#
echo -e "Instalando UNZIP, descompactador e compactador, aguarde..."
	# opção do comando: &>> (redirecionar a saída padrão)
	# opção do comando apt: -y (yes)
	apt -y install unzip &>> $LOG
echo -e "UNZIP instalado com sucesso!!!, continuando com o script"
sleep 5
echo
#

echo -e "Instalando MYSQL SERVER, aguarde..."
	# opção do comando: &>> (redirecionar a saída padrão)
	apt install -y mysql-server &>> $LOG
echo -e "MYSQL SERVER instalado com sucesso!!!, continuando com o script..."
sleep 5
echo
#
echo -e "Instalando Complemento do MYSQL SERVER, aguarde..."
	# opção do comando: &>> (redirecionar a saída padrão)
	apt install -y mysql-common &>> $LOG
echo -e "Complemento instalado com sucesso!!!, continuando com o script..."
sleep 5
echo
#
...
echo
#
echo -e "Criando diretorio e Copiando os arquivos de configuração do Wordpress, aguarde..."
	# opção do comando: &>> (redirecionar a saída padrão)
	# opção do comando mv: -v (verbose)
	# opção do comando cp: -v (verbose)
	mkdir /var/www/html/wp &>> $LOG
